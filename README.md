...
| **APB BUS, AXI4-Lite Protocol, Peripherals 설계** <br> 📅(25.08.26~25.09.05) | - **APB BUS와 AXI4-Lite protocol**을 설계<br> - APB BUS와 AXI4-Lite에 연결되어 동작하는 **peripheral**&#8288;들(RAM, GPI, GPO, GPIO, FND, UART)을 설계<br> - AXI4-Lite에 연결한 peripherals는 **VIVADO IP화**<br> - 동작을 위해 **C code**를 작성하여 실행(APB는 컴파일한 이진 코드, AXI4-Lite는 Vitis 사용) | 대한상공회의소<br>서울기술교육센터 | [APB BUS, AXI4-Lite Protocol, Peripherals 설계](https://github.com/yjm020500/APB_BUS_AXI4-Lite_Protocol_Peripherals) |
