...
| **Project Z :<br> 연구소 탈환 작전** <br> 📅(25.04.25~25.05.07) | - **ARM Cortex-M3** 기반의 STM32 마이크로컨트롤러로 FSM 제어 구조의 게임 로직 구현 및 **하드웨어 데이터시트 기반 레지스터 직접 제어**<br> - 타이머, GPIO, 인터럽트 등 **데이터시트를 참고하여 필요한 기능들의 레지스터 비트를 직접 활성화**하고 활&#8288;용<br> - **임베디드** 환경에서 **레지스터 제어와 인터럽트 기반** 프로그래밍 이해<br> - 두 개의 각각 **다른 역할을 하는 STM32 보드**를 이용하였으며, **두 보드간 UART 통신**으로 데이터 교환 | 대한상공회의소<br>서울기술교육센터 | [GameProject_ProjectZ](https://github.com/yjm020500/GameProject_ProjectZ) |
