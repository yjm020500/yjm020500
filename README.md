...
| **FPGA를 이용한 실시간 영상 처리** <br> 📅(24.11.01~24.12.12) | - **JFK-200A FPGA 보드(Artix-7 XC7A35TFTG256-1)와<br>&nbsp;&nbsp;&nbsp; OV7670 카메라 모듈, VGA666 GPIO to VGA 컨버터**를<br>&nbsp;&nbsp;&nbsp; 사용하여 실시간으로 영상 처리<br> - OV7670으로 받은 영상을 키패드를 통해 선택한 필터로<br> &nbsp;&nbsp;&nbsp; 처리하여 **GPIO 출력**<br> - 선택한 필터 번호는 **7-segment로 표시**<br> - 출력된 **GPIO 신호는** VGA666 컨버터를 통해 **VGA 신호로**<br> &nbsp;&nbsp;&nbsp; 바뀌고, **HDMI 컨버터로 최종 변환**되어 모니터에 입력 | 숭실대학교 | [Image_processing_on_FPGA](https://github.com/yjm020500/Image_processing_on_FPGA) |
